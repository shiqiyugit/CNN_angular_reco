...
def oscNext_L7( 
    ...
    #
    #tray.Add(check_object_exists,object_key='retro_crs_prefit__x')

    tray.Add( lambda frame: frame['I3EventHeader'].sub_event_stream=="InIceSplit", "DropUnusedSubEventStreams")
